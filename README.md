...
In order to use this API, you need to generate a Argentina Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Argentina Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Argentina Post Tracking API](https://www.trackingmore.com/correo-argentino-tracking.html)  to:

   *   Get Argentina Post realtime tracking info of muti-carriers in one integration
   *   Provide Argentina Post shipment tracking experience like Amazon
   *   Push Argentina Post  notifications of package update with webhook
   *   Verify Argentina Post delivery exception before it is too late
